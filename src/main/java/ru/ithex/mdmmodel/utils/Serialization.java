package ru.ithex.mdmmodel.utils;
...
public class Serialization {
    ...
    public static void writeNullableObject(ObjectOutput out, Object obj) throws IOException {
        if (obj == null) {
            ...
            if (obj instanceof UUID)
                out.writeUTF(((UUID) obj).toString());
    ...
    public static UUID readUUIDFromObjectInput(ObjectInput in) throws IOException{
        return in.readBoolean() == true ? UUID.fromString(in.readUTF()) : null;
    }
